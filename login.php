...
<body id="loginDoc" class="pure-skin-vostok">
	<div class="pure-g-r">
		<div class="pure-u-1">
			<header>
				<h1>
		...
		<div class="pure-u-1">
			<p>
				<strong><?php echo ToolBox::toHtml(APPLI_NAME); ?> </strong> est l'outil de prospection <a href="http://www.usocrate.fr" title="Lien vers maison-mère">Usocrate.fr</a>.
			</p>
		...
		<div class="pure-u-1">
			<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" class="pure-form pure-form-stacked">
				...
				<label for="user_name_i">Identifiant</label> <input id="user_name_i" name="user_name" type="text" /> <label for="user_password_i">Mot de passe</label> <input id="user_password_i" name="user_password" type="password" />
				<button name="login_submission" type="submit" value="1" class="pure-button pure-button-primary">Lancement</button>
			</form>
		</div>
		<div class="pure-u-1">
			<footer>
				<q>Reçu. Sens bien, excellent état d'esprit, prêt à y aller</q><br /> <cite>Youri Gagarine, 12 avril 1961</cite>
			</footer>
		</div>

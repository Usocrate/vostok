	...
	<section>
			...
			<div class="form-row">
					<div class="form-group col-md-4 col-sm-12">
						<label for="title_i">Fonction</label> <input id="title_i"
							name="title" type="text" list="title_list"
							value="<?php echo $membership->getTitle(); ?>" size="35"
			...
			<div>
				...
				?>
				<button name="task" type="submit" value="membership_submission"
...
<script type="text/javascript">
	...
	document.addEventListener("DOMContentLoaded", function() {
		...
		function checkIndividualMemberships(e) {
			...
			var exe_condition = ifni.value.length>0 && ilni.value.length>0;
			if (exe_condition == false) {
				console.log('pas glop ! : '+ ifni.value + ' et '+ilni.value);
				return false;
			}  
		...
		if (document.getElementById('individual_firstName_i') !==null) {
			document.getElementById('individual_firstName_i').addEventListener('change', checkIndividualMemberships);
			document.getElementById('individual_firstName_i').focus();
		}
		
		if (document.getElementById('individual_lastName_i') !==null) {
			document.getElementById('individual_lastName_i').addEventListener('change', checkIndividualMemberships);
		}
		<?php endif; ?>
